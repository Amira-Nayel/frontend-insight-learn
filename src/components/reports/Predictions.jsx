    ...
    const handleSubmit = (e) => {
        ...
        if (prediction) {
            setResult(prediction.predictions === 1 ? 
                'The student is predicted to pass this course.' 
                : 
                'The student is predicted to fail this course.'
            );
        } else {
        ...
        <div className="max-md:container flex flex-col border-2 border-c_4 gap-5 dark:text-white bg-c_5 dark:bg-black dark:bg-opacity-50 p-6  mx-auto mt-8">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <div className="flex flex-col">
                    <label htmlFor="email" className="text-lg font-medium">Student Email:</label>
                    <input
                        type="email"
                        id="email"
                        value={email}
                        onChange={handleEmailChange}
                        className="border border-c_4 rounded-md px-3 py-2 dark:bg-black dark:bg-opacity-25 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required
                    />
                </div>
                <div className="flex flex-col">
            ...
            {result && (
                ...
                result === 'The student is predicted to pass this course.' ?
...
export default PredictionChecker;
